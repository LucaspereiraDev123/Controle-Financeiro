# Economiza Certo — Controle Financeiro (SaaS em Laravel)
...
> Nome do produto: **Economiza Certo** (configurável em `APP_NAME`).
...
- **Produção (Brevo)**: envio real via SMTP.
  ...
  MAIL_FROM_ADDRESS="nao-responda@economizacerto.com.br"
  ```
